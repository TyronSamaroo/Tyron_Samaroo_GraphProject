...
// Source used https://www.geeksforgeeks.org/graph-and-its-representations/

public class Graph {


    LinkedList<Integer> list[];  // Store edges
    private int Vertex;                  // Store vertex
    ...
    public void printAllEdges(){
        for (int i = 0; i < Vertex; i++) {
            ...
            for (int j = 0; j <list[i].size() ; j++) {
                System.out.println(list[i].getHead());
            }
            System.out.println();
        }
    }
